...
const playKey = (key) => {
    ...
    // const freq = getHz(keyElem.note, (keyElem.octaveOffset || 0) + 4);
    const freq = getHz(keyElem.note, (keyElem.octaveOffset || 0) + 3);

    if (Number.isFinite(freq)) {
        osc.frequency.value = freq;
    }

    keyElem.element.classList.add("pressed");
...
const stopKey = (key) => {
    ...
    keyElem.element.classList.remove("pressed");
